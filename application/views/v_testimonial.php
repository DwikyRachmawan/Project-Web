...
<head>
    ...
    <link href="<?php echo base_url("assets/img/service-2.JPG")?>" rel="stylesheet">
...
<body>
                ...
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu text-capitalize">
                            ...
                            <a href="<?php echo base_url("") . 'welcome/testimonial/'?>" class="dropdown-item active">Testimonial</a>
                        </div>
                    </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel">
                <div class="testimonial-item">
                    ...
                    <p class="m-0">Convenient place to work alone, small meeting, hangout with friends or business partner with a cup of Coffee, small bites, or having brunch, and so on. Wide parking area for cars or twowheelers. Toilet, praying room (musholla), atm, etc also provided.</p>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center mb-3">
                    ...
                    <p class="m-0">Nice place, opens at 8 am. Great coffee, so flavorful. My cappuccino had a hint of wine coffee.</p>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center mb-3">
                    ...
                    <p class="m-0">Nice and cozy place to hang out. They serve nice and comfy place such as indoor and outdoor seats. I suggest try outdoor seats. Cool and chill wind will pass you by while you're enjoying your time with friends or alone</p>
                </div>
                <div class="testimonial-item">
                    <div class="d-flex align-items-center mb-3">
                    ...
                    <p class="m-0">Come saturday At 5:30 p.m. the main course runs out of the remaining 1 spaghetti tuna. The rest cm light appetizer spt quesadillas or bitterballen. Request without cayenne but the one that comes is full of cayenne. The price is quite expensive, spaghetti 66k, 30k iced tea is also cm 7/8 cup. Taste? 7/10 lah. Plus mlm sunday there is live music.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo base_url("assets/lib/waypoints/waypoints.min.j")?>s"></script>
