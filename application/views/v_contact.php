        ...
        <div class="container">
            ...
            <div class="row px-3 pb-2">
                ...
                <div class="col-sm-4 text-center mb-3">
                    ...
                    <p>LowCoffe1@gmail.com</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 pb-5">
                    <iframe style="width: 100%; height: 443px;"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.029732380603!2d107.00307389999999!3d-6.2598139!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e698dd6e28035a3%3A0xeb68af412b8007e5!2sUniversitas%20Bina%20Sarana%20Informatika%20Kampus%20Bekasi%20(UBSI%20Bekasi)!5e0!3m2!1sid!2sid!4v1666717203146!5m2!1sid!2sid"
                    ...
                    <div class="contact-form">
                        ...
                        <form name="sentMessage" id="contactForm" novalidate="novalidate">
                            <div class="control-group">
                                <input type="text" class="form-control bg-transparent p-4" id="nama" name="nama" placeholder="Your Name"
                            ...
                            <div class="control-group">
                                <textarea class="form-control bg-transparent py-3 px-4" rows="5" id="komentar" name="komentar" placeholder="Message"
                                    required="required"
