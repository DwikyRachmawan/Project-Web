        ...
        <nav class="navbar navbar-expand-lg bg-none navbar-dark py-3 fixed-top">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                <div class="navbar-nav ml-auto p-4">
                    ...
                    <a href="<?php echo base_url("") . 'welcome/service/'?>" class="nav-item nav-link active">Service</a>
            ...
            <div class="row">
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="<?php echo base_url("assets/img/service-1.jpg")?>" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-truck service-icon"></i>Fastest Door Delivery</h4>
                            <p class="m-0">We provides door to door delivery services to client. Our delivery service is quick and easy to use. The entire delivery is trackable right through our app or site. A notification is sent out once a package is delivered. Door to door deliveries are perfect for sending gifts, small parcels, and envelopes.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="<?php echo base_url("assets/img/service-2.jpg")?>" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-coffee service-icon"></i>Fresh Coffee Beans</h4>
                            <p class="m-0">Coffee beans are roasted with dry heat and with constant agitation to ensure even heating. The range of roasts varies from light golden brown all the way to a dark, almost black appearance. Varying the roasting time has a significant effect on the flavor, aroma, and color of the brewed coffee.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="<?php echo base_url("assets/img/service-3")?>.jpg" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-award service-icon"></i>Best Quality Coffee</h4>
                            <p class="m-0">A good quality coffee will have a strong, pleasant aroma that smells fresh. The beans should not feel too greasy or dry. Whole beans should not be rock hard or crumble easily between your fingers. The packaging should have a one-way valve and airtight seal.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mb-5">
                    <div class="row align-items-center">
                        <div class="col-sm-5">
                            <img class="img-fluid mb-3 mb-sm-0" src="<?php echo base_url("assets/img/service-4.jpg")?>" alt="">
                        </div>
                        <div class="col-sm-7">
                            <h4><i class="fa fa-table service-icon"></i>Online Table Booking</h4>
                            <p class="m-0">An online table booking system is the perfect two way to grow your restaurant sales. The above-listed benefits are enough to prove it</p>
                        </div>
                    </div>
                </div>
            </div>
